...
const ProductsData = [
    {
        ...
        img:Img1,
        title:'Casual Wear',
        description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque odit eum fugit?"
    },
     {
        id:2,
        img:Img2,
...
const TopProducts = ({handleOrderPopup}) => {
  return (
    <div id='topProducts' className='container'>
                ...
                {ProductsData.map((data)=>(
                    <div data-aos='zoom-in' className='pt-15 rounded-2xl text-center bg-white dark:bg-gray-800 hover:bg-black/80 dark:hover:bg-primary hover:text-white relative shadow-xl duration-300 group max-w-[300px]'>
                     ...
                     <h1 className='text-xl font-bold'>{data.title}</h1>
                        ...
                        <button className='bg-primary hover:scale-105 duration-300 text-white py-1 px-4 rounded-full mt-4 mb-2 group-hover:bg-white group-hover:text-primary ' onClick={handleOrderPopup}>Order Now</button>
                    </div>
                ))}
